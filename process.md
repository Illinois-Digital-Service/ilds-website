---
layout: default
title: Process | Illinois Digital Service
permalink: /process/
---
...
<div class="page-process">
  ...
  <section class="how-we-work-about">
    <div class="container">
      <h2 class="label">OUR PROCESS</h2>
      <p class="lead">From first conversation to lasting impact, here's how we work with your public agency.</p>
      <br/>
      <div class="process-note">
        <p class="process-note-text">These steps are an outline. We work in an agile way, so the shape and timing of each step will differ from project to project.</p>
      </div>
      <br/>
      <div class="steps">
        ...
        <div class="step step-4">
          ...
          <div class="step-content">
            <h3>Build Brick by Brick</h3>
            <p><strong>We get big things done by breaking them into smaller units of work.</strong></p>
            <br/>
            <p>We'll equip your organization with a product roadmap to guide improvements over time.</p>
            <br/>
        ...
        <div class="step step-5">
          ...
          <div class="step-content">
            <h3>Train to Sustain</h3>
            <p><strong>Our goal is to set you up for success.</strong></p>
            <br/>
            <p>We empower your team to keep going with technology and design progress over the long term.</p>
            <br/>
